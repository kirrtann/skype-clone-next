...
const [search, setSearch] = useState("")
  ...
  const filteredUsers = users.filter((user) => user.contact_name?.toLowerCase().includes(search.toLowerCase()))
          ...
          <div key={user.id} className="flex items-center gap-3 p-3 hover:bg-gray-100 cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-800">{user.contact_name}</span>
              </div>
